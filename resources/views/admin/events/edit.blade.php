...
@section('content')
  ...
  {{-- error summary (kalau partial flash belum nampilin errors) --}}
  @if ($errors->any())
        ...
        <div class="row g-3">
          ...
          {{-- <div class="col-12 col-md-4">
            ...
            <select name="is_auto_mode" class="form-select">
              <option value="0" @selected(old('is_auto_mode', (string)$event->is_auto_mode) === '0')>OFF</option>
              <option value="1" @selected(old('is_auto_mode', (string)$event->is_auto_mode) === '1')>ON</option>
            </select>
          </div> --}}
